...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //WebChormeClient 를 상속받아서 만든 MyWebViewClient 객체 넣어주기
        //웹뷰가 모든 기능을 할 수 있도록(파일업로드 포함)
        //단, AndroidManifet.xml에 외부저장장치를 사용하겠다는 퍼미션이 있어야된다
        webView.setWebChromeClient(new MyWebViewClient());


        //원하는 url 로딩시키기
        webView.loadUrl("http://211.250.184.112:8888/spring05/");
    }
