...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                map.put("addr",addr);
                //요청 url
                String url="http://211.250.184.112:8888/spring04/api/member/insert.do";
    ...
    protected void onStart() {
        ...
        String url="http://211.250.184.112:8888/spring04/api/member/list.do";
    ...
    public void onSuccess(int requestId, Map<String, Object> result) {
        ...
        switch (requestId){
            case REQUEST_INSERT:
                //추가하고 난 후에 어떤 작업을 하나? List에 업데이트 필요
                //ListView 에 출력할 데이터를 서버로 부터 요청을 한다.
                String url="http://211.250.184.112:8888/spring04/api/member/list.do";
                Util.sendGetRequest(REQUEST_LIST, url, null, this);
                //입력창 초기화
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        try {
            ...
            String url="http://211.250.184.112:8888/spring04/api/member/detail.do";
            //요청 파라미터를 Map 에 담는다.
