package com.example.step10viewpager3.ui.main;
...
import com.example.step10viewpager3.CountryDto;
import com.example.step10viewpager3.R;
...
public class CountryFragment extends Fragment {
    ...
    //프레그먼트가 활성화 될때 가장 첫번째로 호출되는 메소드
    @Override
    ...
    //onCreate() 메소드가 호출된 이후에 호출되는 메소드드
   @Override
