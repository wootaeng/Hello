...
public class MainActivity extends AppCompatActivity implements Util.RequestListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        requestBtn.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                String url="http://211.250.184.112:8888/AndroidServer/info.jsp";
        ...
        requestBtn2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String url="http://211.250.184.112:8888/AndroidServer/info2.jsp";
        ...
        requestBtn3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String url="http://211.250.184.112:8888/AndroidServer/info3.jsp";
        ...
        sendBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String url="http://211.250.184.112:8888/AndroidServer/send.jsp";
    ...
    public void onSuccess(int requestId, Map<String, Object> result) {
        ...
        switch (requestId){
            ...
            case 3:
                try {
                    //data 는 [{},{},{}] 형식의 문자열. JSONArray 안에 JSONObject 가 있는 구조
                    JSONArray arr=new JSONArray(data);
                    console.setText("");
                    for (int i=0; i<arr.length(); i++){
                        // { i 번째 JSONObject 참조
                        ...
                        boolean isMan=obj.getBoolean("isMan");
//                        console.append(obj+"\n");
                        console.append("번호:"+num+"이름:"+name+"isMan:"+isMan+"\n");
                ...
                break;
            case 4:
                //data 는 HTML 형식임으로 그냥 EditText에 출력
