...
public class MainActivity4 extends AppCompatActivity implements View.OnClickListener, View.OnLongClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        deletBtn.setOnLongClickListener(this);
    }
    /*
        리스너로 등록한 UI 에 클릭 이벤트가 발생하면 호출하는 메소드
    ...
    public boolean onLongClick(View v){
        Toast.makeText(this, "고만 좀 누르지?", Toast.LENGTH_SHORT).show();
        return false;
    }
